...
export default function VehicleDetailPage() {
  ...
  async function handleIntervalBlur(itemKey: string) {
    const value = intervalInputs[itemKey];
      ...
      {!isNew && (
        <section style={{ marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 12, color: "#999", marginBottom: 12 }}>
            Bakımı yaptıysan butona bas — otomatik bugünün tarihi ve güncel km ile kaydedilir. "Periyot (km)" kutusuna kaç kilometrede bir yapılması gerektiğini yazabilirsin (örn. 10000, 15000) — bu, müşteri sayfasında "yaklaşıyor/kritik" uyarısını tetikler.
          </p>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
                    <label style={{ fontSize: 10, color: "#999", marginBottom: 2 }}>Periyot (km)</label>
                    <input
                      type="number"
                      placeholder="örn. 10000"
                      value={intervalInputs[item.key] ?? ""}
