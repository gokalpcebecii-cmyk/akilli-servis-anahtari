...
export default function LoginPage() {
  ...
  return (
    <main style={{ maxWidth: 360, margin: "80px auto", padding: 24, fontFamily: "system-ui, sans-serif" }}>
      ...
      <h1 style={{ fontSize: 22, marginBottom: 4 }}>İşletme Girişi</h1>
      <p style={{ color: "#666", marginBottom: 24, fontSize: 14 }}>OTOİZ işletme/servis yönetim paneline giriş yapın.</p>
